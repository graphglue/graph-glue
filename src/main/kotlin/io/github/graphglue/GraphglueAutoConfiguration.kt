...
import io.github.graphglue.neo4j.GraphglueNeo4jConfiguration
 ...
 */
@Configuration
@Import(io.github.graphglue.graphql.GraphglueGraphQLConfiguration::class, GraphglueNeo4jConfiguration::class)
@AutoConfigureBefore(
